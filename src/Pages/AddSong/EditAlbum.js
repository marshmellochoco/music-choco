...
export const EditAlbum = () => {
	...
	return (
		<div>
			...
			{add ? <AddAlbum apiUrl={apiUrl} setAlbumID={setSelectedAlbum} /> : null}
			{selectedAlbum && <DeleteSong albumID={selectedAlbum.id} />}
			{selectedAlbum && !add && (
				<AddSong
					apiUrl={apiUrl}
			...
			<form>
				<table>
					<tbody>
						...
						<tr>
							<td colSpan={2}>{icon && <img src={preview} alt='preview' />}</td>
						</tr>
						<tr>
							<td colSpan='2'>
								<button onClick={(e) => postAlbum(e)}>Submit</button>
							</td>
						</tr>
					</tbody>
				</table>
